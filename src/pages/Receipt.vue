      ...
      <div class="col-lg-10 col-xl-8" v-else>
        <div class="card" style="border-radius: 10px;">
          <div class="card-header px-4 py-3">
            <h5 class="text-muted mb-0 text-center">Cảm ơn bạn đã đặt hàng, <span>{{ user.fullname }}</span>!</h5>
          </div>
          <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
              <p class="lead fw-normal mb-0">Hóa đơn</p>
              <p class="small text-muted mb-0">Mã đơn hàng: {{ order._id }}</p>
            </div>
            <div class="card shadow-0 border mb-4">
              <div class="card-body">
                <div class="row mb-1" v-for="product in products">
                  ...
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0 small">Kích thước: Nhỏ</p>
                  </div>
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0 small">Tùy chọn: Không</p>
                  </div>
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                ...
                <div class="row d-flex align-items-center">
                  ...
                  <div class="col-md-10">
                    <div class="progress" style="height: 6px; border-radius: 16px;">
                      <div class="progress-bar bg-dark" role="progressbar" style="width: 33%; border-radius: 16px"
                        aria-valuenow="33" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="d-flex justify-content-around mb-1">
                      <p class="text-muted mt-1 mb-0 small ms-xl-5">Đang chờ</p>
            ...
            <div class="d-flex justify-content-between pt-2">
              ...
              <p class="text-muted mb-0"><span class="fw-bold me-4">Tạm tính</span> ${{ order.total }}</p>
            </div>

            <div class="d-flex justify-content-between pt-2">
              <p class="text-muted mb-0">Ngày lập hóa đơn: {{ new Date(order.createdAt).toLocaleString() }}</p>
              <p class="text-muted mb-0"><span class="fw-bold me-4">Giảm giá</span> $00.00</p>
            </div>

            <div class="d-flex justify-content-between mb-5">
              <p class="text-muted mb-0">Địa chỉ giao hàng: {{ order.shippingAddress }}</p>
              <p class="text-muted mb-0"><span class="fw-bold me-4">Phí vận chuyển</span> $00.00</p>
            </div>
          ...
          <div class="card-footer border-0 px-4 py-3 bg-dark">
            <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">Tổng thanh toán:
              <span class="mb-0 ms-2">${{ order.total }}</span>
            </h5>
          </div>
        </div>
      </div>
